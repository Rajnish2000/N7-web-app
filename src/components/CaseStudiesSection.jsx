...
const CaseStudiesSection = () => {
  return (
    <section className="relative overflow-hidden bg-[#050B12] py-16 text-white text-archivo">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <article className="relative z-10 flex w-full max-w-5xl items-center gap-10 rounded-xl border border-white/5 bg-[#01141B] p-4 shadow-[0_0_60px_rgba(0,180,253,0.08)] backdrop-blur-xl">
            ...
            <div className="px-10 flex flex-1 flex-col justify-center">
              ...
              <div className="mt-8 flex items-center gap-3 text-[#94A3B8]">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#586E84]">
                  <Zap
                    size={24}
                    fill="#000D12"
                    className="stroke-[#000D12] bg-transparent"
                  />
                </div>
              ...
              <button className="group mt-10 flex h-10 w-full max-w-md items-center justify-center rounded-2xl border border-[#4B6178] bg-transparent text-sm font-medium tracking-[0.2em] text-[#94A3B8] transition-all duration-300 hover:border-[#00B4FD] hover:text-white hover:shadow-[0_0_30px_rgba(0,180,253,0.25)]">
                READ MORE
              </button>
            </div>
          </article>
        ...
        <div className="mt-8 w-333.5 flex items-center justify-between">
          <div />
          <div />
          <div className="flex items-center gap-8 mr-30">
            <button className="flex h-10 w-10 items-center justify-center rounded-full border border-[#00B4FD] text-[#00B4FD] transition-all duration-300 hover:bg-[#00B4FD]/10">
              <svg
          ...
          <a
            href="/"
            className="ml-10 group flex items-center gap-2 text-sm font-medium uppercase tracking-[0.18em] text-[#00B4FD]"
          >
            <span>
